...
const ACTION_LABEL: Record<string, string> = {
  ...
  "election.finalize": "Seated the elected board",
  ...
  "trustee.add": "Added a board member",
  "trustee.update": "Updated a board member",
  "trustee.end": "Ended a board member's term",
  "trustee.remove": "Removed a board member",
